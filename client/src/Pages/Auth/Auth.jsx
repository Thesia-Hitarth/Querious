      ...
      >
        ...
        {isForgotPassword ? (
            ...
            {!resetSent && (
              <form onSubmit={handleSubmit} className="auth-form">
                <div className="form-group">
                  <label htmlFor="forgot-email">Email <span style={{ color: "var(--color-danger)" }}>*</span></label>
                  <input
                    type="email"
                    name="email"
                    id="forgot-email"
          ...
          <form onSubmit={handleSubmit} className="auth-form">
            ...
            {isSignup && (
              <div className="form-group">
                <label htmlFor="signup-name">Display Name <span style={{ color: "var(--color-danger)" }}>*</span></label>
                <input
                  type="text"
                  id="signup-name"
                  name="name"
            ...
            <div className="form-group">
              <label htmlFor="auth-email">Email Address <span style={{ color: "var(--color-danger)" }}>*</span></label>
              <input
                type="email"
                name="email"
                id="auth-email"
            ...
            <div className="form-group">
              <div className="password-label-row">
                <label htmlFor="auth-password">Password <span style={{ color: "var(--color-danger)" }}>*</span></label>
                {!isSignup && (
